<?php
/**
 * VanAsltine Voice functions and definitions
 *
...
if ( ! function_exists( 'vanalstine_voice_setup' ) ) :
	...
	function vanalstine_voice_setup() {
		 ...
		 * If you're building a theme based on VanAsltine Voice, use a find and replace
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'vanalstine-voice' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'vanalstine_voice_custom_background_args', array(
...
function vanalstine_voice_scripts() {
	wp_enqueue_style( 'vanalstine-voice-style', get_stylesheet_uri() );

	wp_enqueue_script( 'vanalstine-voice-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'vanalstine-voice-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
